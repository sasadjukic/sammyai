...
Retrieval-Augmented Generation (RAG) helps SammyAI find relevant details from project files without pasting entire documents into the prompt. In v0.5.1-alpha, project context is synchronized automatically for supported files.
