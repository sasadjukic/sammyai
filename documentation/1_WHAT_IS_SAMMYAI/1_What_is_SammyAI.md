...
* In v0.5.2-alpha, SammyAI is organized around writing projects. A project is a normal folder on your computer. SammyAI registers that folder, watches supported files, stores runtime metadata in OS-managed application data, and avoids adding hidden files to your project folder.
