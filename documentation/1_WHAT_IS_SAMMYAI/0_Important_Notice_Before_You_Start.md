## **Welcome to SammyAI v0.5.2-alpha!**

SammyAI v0.5.2-alpha is the current development release. It adds offline US English spell checking to every document tab and the chat composer, with correction suggestions, a personal dictionary, and an on/off toggle in the new Settings dialog.

**Current Status:**

* **Version:** SammyAI v0.5.2-alpha
...
**Highlights of the Current v0.5.2-alpha Experience:**
