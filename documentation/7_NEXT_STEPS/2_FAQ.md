...
Usually, no. In v0.5.1-alpha, supported project files are synchronized automatically. Legacy manual indexing remains under **Advanced > Legacy Manual Indexing** for fallback use.
